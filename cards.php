                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-6 col-sm-4">
                                                <a href="https://www.swcombine.com/members/cockpit/travel/directed.php?travelClass=0&supplied=1&galX=91&galY=-1&sysX=13&sysY=5&surfX=2&surfY=2&groundX=15&groundY=11"
                                                    target="_blank">
                                                    <button type="button" class="btn btn-sm btn-secondary">Black
                                                        Onion</button></a>
                                            </div>
                                            <div class="col-6 col-sm-4">
                                                <a href="https://www.swcombine.com/members/cockpit/travel/directed.php?travelClass=0&supplied=1&galX=370&galY=-230&sysX=16&sysY=10&surfX=3&surfY=1&groundX=10&groundY=18"
                                                    target="_blank">
                            ...
                            <div class="col-12 col-sm-6 col-md-4 col-lg-3" style="padding:0px">
                                <div class="card">
                                    <button type="button" class="btn btn-link collapsed" data-toggle="collapse"
                                        data-target=<?php echo "#collapse-owned-$counter"?> aria-expanded="false"
                                        aria-controls=<?php echo "collapse-owned-$counter"?>>
                                        <div class="card-header">
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="card border border-darker" style="height:100%">
                                                        ...
                                                        <div class="card-body center">
                                                            <div style="padding:0px"
                                                                class="pazaak-img border border-darker"
                                    ...
                                    <div id=<?php echo "collapse-owned-$counter"?> class="collapse"
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-6 col-md-4 col-lg-3" style="padding:0px">
                                <div class="card">
                                    <button type="button" class="btn btn-link collapsed" data-toggle="collapse"
                                        data-target=<?php echo "#collapse$counter"?> aria-expanded="false"
                                        aria-controls=<?php echo "collapse$counter"?>>
                                        <div class="card-header">
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="card border border-darker" style="height:100%">
